...
#MACRO if _cond {
    ...
    jr invert_condition(_cond), __if_label_ ## _if_enter_counter
    #PUSH _if_stack, _if_enter_counter
} end {
    #POP _if_stack, _if_current_label_nr
    __if_label_ ## _if_current_label_nr:
} else {
    #POP _if_stack, _if_current_label_nr
    #PUSH _if_stack, _if_current_label_nr
    jr __ifelse_label_ ## _if_current_label_nr
    __if_label_ ## _if_current_label_nr:
} end {
    #POP _if_stack, _if_current_label_nr
    __ifelse_label_ ## _if_current_label_nr:
} else.jp {
    #POP _if_stack, _if_current_label_nr
    #PUSH _if_stack, _if_current_label_nr
    jp __ifelse_label_ ## _if_current_label_nr
    __if_label_ ## _if_current_label_nr:
} end {
    #POP _if_stack, _if_current_label_nr
    __ifelse_label_ ## _if_current_label_nr:
...
#MACRO if.jp _cond {
    _if_enter_counter = _if_enter_counter + 1
    jp invert_condition(_cond), __if_label_ ## _if_enter_counter
    #PUSH _if_stack, _if_current_label_nr
} end {
    #POP _if_stack, _if_current_label_nr
    __if_label_ ## _if_current_label_nr:
